          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm leading-relaxed">
                ...
                y vende de forma segura entre particulares y comerciantes
                licenciados.
              </p>
            </div>
            <div>
              ...
              <p className="text-xs leading-relaxed">
                Todas las transacciones deben cumplir con las leyes de Puerto
                Rico y federales de EE.UU. Es responsabilidad del comprador y
                vendedor cumplir con los requisitos de licencia y transferencia
                aplicables.
              </p>
            </div>
            <div>
